...
# MAGIC %md
# MAGIC # (Optional) - Stream-Stream Joins
# MAGIC
# MAGIC ##### Objectives
...
# MAGIC We are going to use the canonical example of ad monetization, where we want to find out which ad impressions led to user clicks. 
...
# MAGIC
# MAGIC   a. Time range join conditions (e.g. `...JOIN ON leftTime BETWEEN rightTime AND rightTime + INTERVAL 1 HOUR`),
# MAGIC   
