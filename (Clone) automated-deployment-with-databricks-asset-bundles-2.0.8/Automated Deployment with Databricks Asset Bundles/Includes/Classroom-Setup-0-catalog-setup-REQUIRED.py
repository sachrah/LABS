...
def create_course_csv_files(self,
    ...
    def create_dev_csv_files(self):
        ...
        ## Del files with underscores after writing the csv files
        util_del_files_with_underscore_in_volume(self, dev_volume_write_path)

        ## Rename file with the filter condition + data_name_append
        ## Rename file with the filter condition + data_name_append
        util_rename_csv_file(self, dev_volume_write_path, file_prefix="dev", file_suffix=data_name_append)
