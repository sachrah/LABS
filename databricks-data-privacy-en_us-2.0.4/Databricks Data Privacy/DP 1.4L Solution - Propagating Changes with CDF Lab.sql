...
-- MAGIC %python
-- MAGIC user_lookup_df = (spark
-- MAGIC                   .read
-- MAGIC                   .format("delta")
-- MAGIC                   .option("readChangeData", True) # Reading Change Data
-- MAGIC                   .option("startingVersion", 1)  # Start Reading Version
-- MAGIC                   .table("user_lookup")
-- MAGIC )
-- MAGIC
-- MAGIC display(user_lookup_df)
